...
- `Conversion failed for JPEG image: <error detail>` — a JPEG-specific conversion failure
- `Unsupported file type or unsupported format for markitdown-rs.` — the file extension was not recognised by the converter
